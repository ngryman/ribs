...
/**
* Fetch coordinates of a landmark point applied to given `width` and `height`.
*
* @param {string} landmark - The landmark point.
* It can be one of the following values (non order sensitive):
*  - `tl`: top left
*  - `t`: top center
*  - `tr`: top right
...
* @param {object} coords - Output coordinates, will hold `x` and `y` values of the landmark point.
*/
utils.computeAnchor = function(landmark, width, height, coords) {
	// compute region's origin taking landmark as anchor and 0,0 as origin.
	// This gives us negative coordinates that are the result of central symmetry around 0,0
	utils.computeRegionOrigin(landmark, width, height, 0, 0, coords);
